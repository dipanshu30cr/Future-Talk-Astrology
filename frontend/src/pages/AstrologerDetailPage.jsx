...
import { FaCalendarAlt, FaClock, FaRupeeSign, FaUser, FaStar, FaLanguage, FaCheck } from 'react-icons/fa';
...
const AstrologerDetailPage = () => {
  ...
  const handleBooking = async (e) => {
    ...
    try {
      ...
      // Send the request without the 'customer' field
      const response = await axios.post('http://localhost:9000/api/bookings/customer/', bookingData);

      
      
      console.log('Response Object:', response);  // Logs the full response object
      console.log('Response Data:', response.data);  // Logs just the data part of the response
